...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>	
	<div id="wrapper">
		...
		<div id="sidebar-wrapper">
			<div id="gw-sidebar" class="gw-sidebar">
				...
				src="images/combinedlogo1.png" alt="Assocham" style="height: 76px;margin-left: 27px" id="AssohamLogo"> 
								...
								alt="resurgent rating" id="scorelogo">
						</a></li>
						...
						<li class="init-arrow-down menu-item"><a
							...
							href="javascript:void(0)"> <i class="fa fa-user"
								aria-hidden="true"></i> <span class="gw-menu-text"
								style="padding-left: 6px;margin-left: 28px;">Admin Panel</span> <b></b>
						</a>
							<ul class="gw-submenu"
								style="background: transparent !important;">
								<li><a href="javascript:void(0)"
									onclick="callApp('page,businesstype');"><span
										class="gw-menu-text">Business Type</span></a></li>
							    <li><a href="javascript:void(0)"
									onclick="callApp('page,industrytype');"><span
										class="gw-menu-text">Industry Type</span></a></li>	
							<li><a href="javascript:void(0)"
									onclick="callApp('page,institute');"><span
										class="gw-menu-text">Add Institute</span></a></li>	
						    <li><a href="javascript:void(0)"
									onclick="callApp('page,institutemapping');"><span
										class="gw-menu-text">User Institute Mapping</span></a></li>					
							<li><a href="javascript:void(0)"
									onclick="callApp('page,importexcel');"><span
										class="gw-menu-text">Import Excel</span></a></li>
							    <li><a href="javascript:void(0)"
									onclick="callApp('page,downloadcsv');"><span
										class="gw-menu-text">Download CSV</span></a></li>
							    <li><a href="javascript:void(0)"
									onclick="callApp('page,indinstitutemap');"><span
										class="gw-menu-text">Industry Map</span></a></li>	
										<li><a href="javascript:void(0)"
									onclick="callApp('page,bankstatementreport');"><span
										class="gw-menu-text">Bank Statement report</span></a></li>	
										<li><a href="javascript:void(0)"
									onclick="callApp('page,documentdownload');"><span
										class="gw-menu-text">Upload Documents Download</span></a></li>
												<li><a href="javascript:void(0)"
									onclick="callApp('page,adminrule');"><span
										class="gw-menu-text">Admin Rule</span></a></li>		
										<li><a href="javascript:void(0)"
									onclick="callApp('page,bankdetails');"><span
										class="gw-menu-text">Bank Detail</span></a></li>
										<li><a href="javascript:void(0)"
									onclick="callApp('page,bankstatement');"><span
										class="gw-menu-text">Bank Statement</span></a></li>				
                      ...
                      <span class="gw-menu-text" style="padding-left: 9px;margin-left: 12px">Analyse  Statement </span>
						 <b class="gw-arrow"></b>
						</a></li>
		...
		<div id="page-content-wrapper">
			<form id="appform" action="app" method="post">
			  <input type="hidden" id="mobileNoVerify" name="mobileNoVerify">
			</form>
			<section class="vbox">
				<header
