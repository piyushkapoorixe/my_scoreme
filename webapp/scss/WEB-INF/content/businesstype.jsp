				...
				<section class="scrollable padder">
					<section id="content" class="m-t-lg wrapper-md animated fadeInDown">
						<div class="container aside-xl" style="border: 1px solid #ccc;margin-bottom:10px;">
							<h3 class="head-txt">Business Type</h3>
							<section class="m-b-lg">
								
								<form id="businesstype-form" data-validate="parsley" action="#">
								
								<div class="alert alert-success alert-dismissable" id="save-businesstype" style="display:none;">
                                  <strong>Success!</strong>Business Type Saved successfully.
                                </div>
                   
                                <div class="alert alert-danger alert-dismissable" id="save-businesstype-failure" style="display: none;">
                                  <strong>Failure!</strong>Unable To Save Business Type.
                                </div>
								...
								<div class="list-group">
										<div class="list-group-item">
											<input type="text" name="businessType" id="businessType"
												...
												text="Please enter Business type" ng-model="businessType"
												placeholder="Enter Business Type" data-required="true">
										</div>
									</div>
									
									<button type="button" 
										class="btn btn-lg btn-primary btn-block"
										ng-click="addBusinessType()" id="addbusiness-button"
					...
					<div class="col-lg-12 table-responsive">
						<div class="col-lg-12 table-responsive">
							<table
								...
								<tbody id="businessMap">
                             <tr ng-repeat="i in businessTypeAdminData.data">
...
window.onload = function() {	
	$("#businessType").keypress(function(event){
			...
			if ((data.resp_code) == 'CS1002') {
	            ...
	            $.each(data.data, function(key, industrygroup) {
	                //$('#businessType').append('<option value="' + industrygroup.id + '">' + industrygroup.groupName + '</option>');
	            	 $("#businessMap").append("<tr><td style='text-align:center;'>"+i+"</td><td style='text-align:center;'>"+industrygroup.groupName+"</td></tr>");
	            	 i++;
	            });
	            $("#example").DataTable();
	        } else {
...
function hidediv(a) {
 ...
 /*  function addBusinessType(){
	  if ($("#businesstype-form").parsley('validate')) {

		  var jsonData={
				groupName:$("#businessType").val()  
		  }
		  $.ajax({
				url : "rest/cs/createBusinessType",
				type : 'POST',
				dataType : "json",
				contentType : "application/json; charset=utf-8",
				...
				complete : function(data, textStatus, $XHR) {	
					...
					if (data["resp_code"] == "CS1002"){
						console.log("success");
						$("#businessType").val('');
						 $("#save-businesstype").show();
						 $("#save-businesstype").delay(2200).fadeOut(500);
						
					}
					else{
						$("#save-businesstype-failure").show();
						 $("#save-businesstype-failure").delay(2200).fadeOut(500);
