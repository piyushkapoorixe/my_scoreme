						...
						<div class="col-sm-12"
							...
							<form id="zerobond-form" data-validate="parsley" action="#">
								<div class="panel-group m-b" id="accordion2">
									...
									<c:forEach items="${companyBean.zeroBondData}" var="entry"
										varStatus="loop">
										<c:if
							...
							<div class="col-sm-6 col-sm-offset-1 text-right">
								&nbsp;&nbsp;
									<button type="button" onclick="generateScore()"
										...
										style="background: #8BC34A !important; border: 1px solid #689F38 !important" id="cnfrmBtn">Confirm</button>
							</div>
<!-- 						</div> -->
<!-- 					</div> -->
		...
		$.ajax({
			...
			complete : function(data, textStatus, $XHR) {
				...
				if (data["resp_code"] == "CS1002") {
					...
					$("#rating_now").html("Interest Rate on Bond: " + grade.toFixed(2));
