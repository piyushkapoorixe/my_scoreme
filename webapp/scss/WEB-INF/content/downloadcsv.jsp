				...
				<section class="scrollable padder">
					<section id="content" class="m-t-lg wrapper-md animated fadeInDown">
						<div class="container aside-xl" style="border: 1px solid #ccc;margin-bottom:10px;">
							<h3 class="head-txt">Download CSV</h3>
							<section class="m-b-lg">
							  
								<form id="downloadcsv-form" data-validate="parsley" action="DownloadCSVReport" >
								   <div class="alert alert-danger alert-dismissable" id="date-failure" style="display: none;">
                                     <strong>Failure!</strong> To Date Should Equal or Greater Than From Date.
                                   </div>
                                   
                                    <div class="alert alert-danger alert-dismissable" id="date-first" style="display: none;">
                                     <strong>Failure!</strong> Select From Date First.
                                   </div>
									
								  <div class="list-group">
									<span>From Date <b style="color: red;">*</b></span>
										<div class="list-group-item">
										<input type="date" class="form-control no-border" name="from-date"
																id="from-date" data-required="true">
										</div>
										
									</div>
									
									<div class="list-group">
										<span>To Date <b style="color: red;">*</b></span>
										<div class="list-group-item">
										<input type="date" class="form-control no-border" name="to-date"
																id="to-date" data-required="true">
										</div>
