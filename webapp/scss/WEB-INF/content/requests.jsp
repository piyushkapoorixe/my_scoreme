...
<section id="content">
	<section class="vbox">
		<section class="scrollable padder">
			<div class="m-b-md">
				<h3 class="m-b-none">Score - All Requests</h3>
			</div>
			<section class="panel panel-default">
				<header class="panel-heading">
					All Requests <i class="fa fa-info-sign text-muted"
				...
				<div class="table-responsive">
					<table class="table table-striped m-b-none" data-ride="datatables">
						...
						<tbody>
							<c:forEach var="r" items="${requestBean.allRequests}">
							<tr>
