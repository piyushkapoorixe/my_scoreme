		...
		<section>
				...
				<section class="scrollable padder">
					<section id="content" class="m-t-lg wrapper-md animated fadeInDown">
						<div class="container aside-xl" style="border: 1px solid #ccc;margin-bottom:10px;">
							<h3 class="head-txt">Add  Institute</h3>
							<section class="m-b-lg">
							
							
								<form id="institute-form" data-validate="parsley" action="#">
								
								<div class="alert alert-success alert-dismissable" id="save-institute" style="display:none;">
                                  <strong>Success!</strong>Institute Saved successfully.
                                </div>
                                
                                <div class="alert alert-danger alert-dismissable" id="save-institute-failure" style="display: none;">
                                  <strong>Failure!</strong>Unable To Save Institute.
                                </div>
									...
									<span>Institute Name <b style="color: red;">*</b></span>
										<div class="list-group-item">
											<input type="text" name="instituteName" id="instituteName" ng-model="instituteName"
												class="form-control no-border" maxlength="50"
												text="Please Enter Institute Name"
												placeholder="Enter Institute Name" data-required="true" >
										</div>
										
										<span>Address <b style="color: red;">*</b></span>
										<div class="list-group-item">
											<textarea rows="3" cols="10" id="address" ng-model="address"
												class="form-control no-border" 
												placeholder="Enter Address" data-required="true" >
											</textarea>
										</div>
									
									<div ng-controller="stateCommonController"> 	
                                    <span>State <b style="color: red;">*</b></span>
									<div class="list-group-item">
									...
									<div class="list-group-item">
										<select name="partner_city" id="partner_city" ng-model="partner_city"
											data-required="true" title="Please select city"
											class="form-control no-border">
                                    ...
                                    <span>Contact Name <b style="color: red;">*</b></span>
									<div class="list-group-item">
										<input type="text" name="contactName" id="contactName" ng-model="contactName"
											class="form-control no-border" maxlength="50"
											text="Please Enter Institute Name"
										 placeholder="Enter Name" data-required="true">
									</div>
	                                
	                                <span>Contact Number <b style="color: red;">*</b></span>								
									<div class="list-group-item">
										<input type="text" name="contactNumber" id="contactNumber" ng-model="contactNumber"
											class="form-control no-border" maxlength="10"
											text="Please Enter Institute Name"
										 placeholder="Enter Mobile Number" data-required="true">
									</div>
		                            
		                            <span>Institute Type <b style="color: red;">*</b></span>							
									<div class="list-group-item">
										<select name="instituteType" id="instituteType" ng-model="instituteType"
											data-required="true" title="Please select Institute"
											class="form-control no-border">
											...
											<option value="Public Limited - listed">Public Limited - listed</option>
										</select>
									</div>
									...
									<button type="button" 
										class="btn btn-lg btn-primary btn-block"
										 id="create-button" ng-click="addInstitute()"
			...
			<div class="col-lg-12 table-responsive">		
                          <table class="table table-bordered table-striped table-responsive" id="example">
                              <thead>
                               <tr><th style="text-align: center;">Institute</th>
                               </tr>
                             </thead>
                           <tbody id="instituteTable">
                             <tr ng-repeat="i in instituteData.data">
		...
		complete : function(data, textStatus, $XHR) {
			...
			if ((data.resp_code) == 'CS1002') {
	            ...
	            $.each(data.data, function(key, institute) {
	                $('#instituteTable').append("<tr><td style='text-align:center;'>"+institute.instituteName+"</td></tr>");
	            });
		...
		$.ajax({
			...
			complete : function(data, textStatus, $XHR) {	
				...
				if (data["resp_code"] == "CS1002"){
				     ...
				     $("#contactNumber").val(''),
				     $("#instituteType").val('')
				     $("#save-institute").delay(2200).fadeOut(500);
					
				}
				else{
					 $("#save-institute-failure").show();
					 $("#save-institute-failure").delay(2200).fadeOut(500);
					console.log(data["resp_code"]);
				}
			}
		});
