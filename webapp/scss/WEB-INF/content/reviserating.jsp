...
<section id="content" ng-controller="ratingController">
		...
		<section>
			<section class="vbox gradient">
				<section class="scrollable padder">
					...
					<section class="row m-b-md">
						<div class="col-sm-1"></div>
						<div class="col-sm-10 tbl-box">
							<div class="table-responsive">
								<table class="footable table table-striped m-b-none"
									data-filter="#filter" data-page-size="15">
									<thead>
										<tr>
											<th style="border-left:1px solid #ccc;border-top:1px solid #ccc;border-bottom:1px solid;">Dated</th>
											<th style="border-left:1px solid #ccc;border-top:1px solid #ccc;border-bottom:1px solid;">Score</th>
											<th style="border-left:1px solid #ccc;border-top:1px solid #ccc;border-bottom:1px solid;">Grade</th>
											<th style="border-left:1px solid #ccc;border-top:1px solid #ccc;border-bottom:1px solid;">Certificate</th>
											<th style="border-right:1px solid #ccc;border-top:1px solid #ccc;border-bottom:1px solid;">Action</th>
										</tr>
									</thead>
									<tbody style="border: 1px solid #ccc;">
										<c:forEach var="r" items="${appBean.ratingDTOs}">
											<tr>
												<td>${r.requestDate}</td>
												<td>${r.score}</td>
												<td>${r.grade}</td>
												<td><c:choose>
														<c:when
															test="${r.certificate != null and r.certificate != ''}">
															<a href="${r.certificate}" target="_blank" style="border-bottom: 1px solid #f44300; padding: 3px; text-transform: uppercase; font-size: 11px;">Download</a>
														</c:when>
														<c:otherwise>
															<i>Not Available</i>
														</c:otherwise>
												...
												<td>
												<a href="#" 
													onclick="callApp('page,rating,companyId,${appBean.companyId},id,${r.ratingId}');"
													class="auto restart-btn"> <i class="i i-docs icon"> </i> <span
														class="font-bold"
														title="Proceed with data from this request">revise score</span>
												</a>&nbsp;&nbsp;&nbsp; <a href="#" style="display: none;"
													onclick="callApp('page,sliderrating,companyId,${appBean.companyId},id,${r.ratingId}');"
													class="auto"> <i class="i i-docs icon"> </i> <span
														class="font-bold"
														title="Proceed with data from this request">Slider</span>
												</a>
												</td>
											</tr>
										</c:forEach>
